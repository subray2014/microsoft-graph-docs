...
| Create alert | [Create alert](../api/alert-create.md) | [https://graph.microsoft.com/beta/security/alerts](https://developer.microsoft.com/graph/graph-explorer?request=security/alerts&method=POST&version=beta&GraphUrl=https://graph.microsoft.com) |
