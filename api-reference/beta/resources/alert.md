...
|lastEventDateTime|DateTimeOffset|Time at which the alert entity was last logged.|
...
|messageSecurityStates|[messageSecurityState](../resources/messagesecuritystate.md) collection|Particulars of the message such as source address, message and timestamp of the message|
