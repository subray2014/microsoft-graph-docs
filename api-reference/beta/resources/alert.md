...
|[Create alert](../api/alert-create.md)| [alert](alert.md)|Create an alert object.|
...
|alertDetections|[alertDetection](../resources/alertdetection.md) collection|Detection type, method and name of the alert detection|
...
|investigationSecurityStates|[investigationSecurityState](../resources/investigationsecuritystate.md) collection|Name and status.|
|lastEventDateTime|DateTimeOffset|Date and time when the alert entity was last logged, in ISO 8601 format, and always in UTC time.|
...
|messageSecurityStates|[messageSecurityState](../resources/messagesecuritystate.md) collection|Criticalinformation about the alert message such as source address, message and timestamp of the message|
